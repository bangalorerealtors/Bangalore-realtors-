                    ...
                    <div className="bg-black/30 lg:py-64 md:py-28 py-10">
                        <div className="flex flex-col items-center gap-6">
                            <h2 className='text-white lg:text-52 md:text-40 text-3xl max-w-3/4 text-center font-medium'>
                                Begin your journey to the right address.
                            </h2>
                            <p className='text-white/70 text-lg text-center max-w-xl'>
                                Connect with our advisors today. The right home — and the right guidance — await.
                            </p>
